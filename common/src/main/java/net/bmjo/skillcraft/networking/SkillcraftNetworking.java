package net.bmjo.skillcraft.networking;

import dev.architectury.networking.NetworkManager;
import net.minecraft.util.Identifier;
import net.bmjo.skillcraft.SkillcraftIdentifier;
import net.bmjo.skillcraft.networking.packet.LevelUpC2SPacket;
import net.bmjo.skillcraft.networking.packet.SkillSyncS2CPacket;
import net.bmjo.skillcraft.networking.packet.SyncRequestC2SPacket;
